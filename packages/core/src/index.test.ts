...
function profile(): BrowserProfile {
  const id = randomUUID();
  return { id, name: "Test", userDataDir: `C:/profiles/${id}`, proxyProfileId: null, shippingProfileId: null, paymentProfileId: null, checkoutModeOverride: "INHERIT_TARGET", captchaStrategyOverride: "INHERIT_TARGET", driver: { kind: "NATIVE_STEALTH" }, enabled: true, createdAt: 1, updatedAt: 1 };
}
