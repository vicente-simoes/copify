...
const target: TargetSnapshot = { targetId: "00000000-0000-4000-8000-000000000001", name: "Jacket", storeId: "supreme-eu", productKeywords: ["Leather Jacket"], negativeKeywords: ["Kids"], directProductUrl: null, preferredColors: ["Black", "Red"], sizePriority: ["M", "L"], currency: "EUR", maxRetailMinor: 20_000, quantity: 1, checkoutMode: "ASSISTED", maxCheckouts: "UNLIMITED", captchaStrategy: "INHERIT_APP", enabled: true, capturedAt: 1 };
