...
- Proxy credentials stay encrypted at rest and are decrypted only in Electron main for runner launch or an explicit, native-confirmed 30-second reveal. Reveals are never logged; copied values auto-clear from the clipboard after 60 seconds if unchanged.
